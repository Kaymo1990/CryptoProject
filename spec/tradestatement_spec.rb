...
describe TradeStatement do
    describe '#tradeRecommendationStatements' do
        it 'should return a statement indicating high volatility' do
            expectedOutput = "There is a high volatility of 0 compared to the benchmark of 0.03.
        ...
        it 'should return a statement indicating low volatility' do
            expectedOutput =  "There is a low volatility of 0 compared to the benchmark of 0.03.
        ...
        it 'should return a statement indicating trade above the average' do
            expectedOutput =  "The current price of bitcoin is above the 100 day moving average.
        ...
        it 'should return a statement indicating trade below the average' do
            expectedOutput = "The current price of bitcoin is below the 100 day moving average.
